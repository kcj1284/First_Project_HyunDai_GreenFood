...
//		ann.setVisiter(34);
	...
	public static void 공지사항_수정() {
		...
		ann.setMain_text("특히, ‘건강식단’메뉴는 ①적당한 포만감의 낮은 칼로리 식단과 ②채식 및 해산물 중심의 식재 활용, 그리고 ③발표 음식 선호 등 전세계 블루존 지역의 공통적인 3대 식습관을 고려해 국내 소비자들의 입맛과 취향에 맞게 만든 게 특징이다. 또한 장수마을 사람들이 섭취하던 먹거리와 유사한 성분의 식재를 사용하기 위해 여주(열대과일)와 오크라(아열대 채소) 등 30여 종의 새로운 식재를 도입했다. "
