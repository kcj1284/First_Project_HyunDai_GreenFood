	...
	<div>
		<div class="sub_contents">
			...
			<div class="tab_list">
				...
				<li class="on"><a href="External_Auditor.jsp">외부감사인</a></li>
			...
			<h3 class="esg_title">외부감사인</h3>

			<div class="director_area">
				<div>
					<table class="list_tb">
						<caption class="blind">외부감사인</caption>
						<colgroup>
							<col width="15%" />
							<col width="20%" />
							<col width="*" />
						...
						<thead>
							<tr>
								...
								<th scope="col">최근 감사의견</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="first">삼정회계법인</td>
								<td>2022년 2월 14일</td>
								<td>55기(2022년) 사업연도 ~ 57기(2024년) 사업연도</td>
								<td>적정</td>
							</tr>
						</tbody>
					</table>
