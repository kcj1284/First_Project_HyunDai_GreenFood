		...
		<div class="sub_layout esg_area">
			...
			<div class="sub_contents">
				...
				<section class="esg_section cont3_1_1">
					...
					<div class="esg_text">
						현대그린푸드는 기업의 사회적 책임의 수행하기 위해 노력하고, <br class="pc">사회공헌활동을 통해
						지역사회, 임직원, 고객에게 나눔과 사랑을 실천합니다.
					</div>
					...
					<div class="esg_box num1 hPara">
						<div class="visual">
							<div class="visual_item">
								...
								<div class="visual_txt">
									현대그린푸드는 사회 전체의 <br>균형있는 발전을 추구합니다. <br> <br>성남시
									거주 당뇨질환 독거노인 대상 <br>그리팅 저당식단 지원, 보훈가족 지원, <br>사랑의
									김장나눔 등 <br>지속적인 나눔 활동에 앞장서고 있습니다.
								</div>
							</div>
						</div>
						...
						<ul>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_01.jpg" alt="">
								</div>
								<div class="box_tit">성남시 독거노인 대상 식단 제공</div>
								<div class="box_txt">
									2020년 3월부터 성남시 독거노인지원센터와 은행1동복지회관과 협력하여 성남시에 거주하시는 <br
										class="pc">당뇨 질환을 가진 독거노인 170여 분을 대상으로 매주 4끼의 그리팅 저당식단을
									제공하고 있습니다.
									<div class="box_txt2">
										<span>2021년 수혜인원 170명 / 기부금 2억 원</span>
									</div>
								</div>
							</li>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_02.jpg" alt="">
								</div>
								<div class="box_tit">보훈대상가족 지원</div>
								<div class="box_txt">
									국가보훈처 보훈대상가족을 위해 매년 설맞이 명절선물을 전달하고 있으며, <br class="pc">복날맞이
									보양식 지원 등 현대그린푸드의 건강식 그리팅을 통한 영양지원을 실천하고 있습니다.
									<div class="box_txt2">
										<span>2021년 국가보훈처장 감사패 수여</span>
									</div>
								</div>
							</li>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_03.jpg" alt="">
								</div>
								<div class="box_tit">사랑의 김장나눔 진행</div>
								<div class="box_txt">
									현대그린푸드는 매년 사랑의 김장나눔을 실시하고 있습니다. 2021년에는 저소득 노인가정에게 김치 4,000 <br
										class="pc">포기를 전달하였으며 앞으로도 더 많은 관내 어르신들께 따뜻한 나눔이 전달될 수
									있도록 노력하겠습니다.
									<div class="box_txt2">
										<span>2021년 관내 저소득 노인가정 1,000가구에 전달</span>
									</div>
								</div>
							</li>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_04.jpg" alt="">
								</div>
								<div class="box_tit">노인복지관 대상 공기청정기 지원</div>
								<div class="box_txt">
									노인분들의 건강 관리를 위하여 전국의 노인복지관에 공기청정기를 보급하고 있습니다.
									<div class="box_txt2">
										<span>2021년 노인복지관 197개소 전달</span>
									</div>
								</div>
							</li>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_05.jpg" alt="">
								</div>
								<div class="box_tit">사회적 기업 판로지원·제품 구매 지원</div>
								<div class="box_txt">
									영세한 규모, 경쟁력 부족, 재정적 어려움을 겪는 사회적기업에 제품 판로 확대 및 교육 지원을 <br
										class="pc">제공하고 있습니다. <br>발달 장애인이 만든 제품 구입 <br>·
									베어베터-쿠키/커피 &nbsp; &nbsp; · 에이스푸드-계육
								</div>
							</li>
						</ul>
					...
					<div class="esg_box num2">
						<div class="visual">
							<div class="visual_item">
								...
								<div class="visual_txt">
									현대그린푸드는 탄소중립 숲 조성, <br>생물종 다양성 보전사업 등에 참여하여 <br>환경부문에서도
									사회공헌활동에 <br>앞장서고 있습니다.
								</div>
							</div>
						</div>
						...
						<ul>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_06.jpg" alt="">
								</div>
								<div class="box_tit">탄소중립 숲 조성</div>
								<div class="box_txt">
									현대백화점 그룹은 2021년부터 산림청과 연계하여 CSR 차원 탄소중립의 숲 조성 사업을 <br
										class="pc">추진하고 있습니다. 탄소중립 숲 조성을 통해 온실가스 배출량을 제로화하여 탄소중립
									실천에 <br class="pc">적극 참여하고자 합니다.
									<div class="box_txt2">
										<span>2027년까지 소나무 약 3,700그루 식재 예정</span>
									</div>
								</div>
							</li>
							<li>
								<div class="box_img">
									<img src="../img/ESG/crs_07.jpg" alt="">
								</div>
								<div class="box_tit">생물종 다양성 보전사업 참여</div>
								<div class="box_txt">
									현대그린푸드는 낙동강유역환경청의 생태계 교란 생물 뉴트리아 퇴치에 필요한 식재(미끼)를 <br class="pc">제공하여
									유해 외래종(뉴트리아) 퇴치를 위한 토종 생물 보전 및 보호 활동에 참여하고 있습니다.
									<div class="box_txt2">
										<span>과채류 및 영남지역 전처리 센터 가공 부산물 공급</span>
									</div>
								</div>
							</li>
						</ul>
				...
				<section class="esg_section cont3_1_2">
					...
					<div class="esg_text">
						현대그린푸드는 사회공헌 활동에 매년 영업이익 1%이상의 기부금을 집행하고 있으며 <br class="pc">매년
						목표액 대비 100%이상 달성률을 선보이고 있습니다.
					</div>
				...
				<section class="esg_section cont3_1_3">
					...
					<div class="esg_text">
						현대그린푸드는 자발적인 기부활동인 ‘매칭그랜트’ 프로그램을 통해 <br class="pc">다양한 사회공헌
						활동에 활용하고 있습니다.
					</div>
				...
				<section class="esg_section cont3_1_4">
					...
					<div class="esg_text">
						현대그린푸드는 매년 사회공헌기금의 일부를 지역사회 환원을 위하여 사용하고 있으며, <br class="pc">전체
						기금의 30% 이상을 환원 목표로 하고 있습니다. 또한, 매년 지역사회 CSR활동에 대하여 재무적/비재무적 가치를 <br
							class="pc">측정하여 관리하고 있으며, 우리의 사업의 성과가 지역 상생에 힘이 되고자 노력합니다.
					</div>
							...
							<table class="list_tb">
								...
								<tbody>
									<tr>
										...
										<td>
											<ol class="director_division_list">
												<li>- 성남지역 독거노인 167명 매주 4끼 <br>식사 제공
												</li>
												<li>- 신사업 'Greating' 공급목적에 부합하는 <br>진정성 확보
												</li>
											</ol>
										</td>
									</tr>
									<tr>
										<td>상대원동 '작은 도서관'<br>건립 지원
										</td>
										<td>- 문화시설 취약 소외계층 대상 : 20백만원</td>
										<td>
											<ol class="director_division_list">
												<li>- 신사업 제조시설 인근 문화 지원사업 참여</li>
												<li>- 도서관 위치 단지 내 2,510가구 아동 이용</li>
											</ol>
										</td>
									</tr>
									<tr>
										...
										<td>
											<ol class="director_division_list">
												<li>- 용인시 수지지역 저소득층 800가구<br> 겨울철 김장김치 제공
												</li>
											</ol>
										</td>
									</tr>
									<tr>
										<td>직업재활카페<br>커피원두 후원
										</td>
										<td>
											<ol class="director_division_list">
												<li>- 사회적 기업 커피원두 구매 후원<br>: 10백만원
												</li>
											</ol>
										</td>
										<td>
											<ol class="director_division_list">
												<li>- 관내 결혼이주여성 80명/年<br> 교육훈련 수료
												</li>
												<li>- 발달 장애인이 만든 쿠키/커피 구입 지원</li>
											</ol>
										</td>
									</tr>
									<tr>
										<td class="first" rowspan="2">기타</td>
										<td>영남지역 아동복지시설<br>재능나눔
										</td>
										<td>
											<ol class="director_division_list">
												<li>- 당사 영양사, 조리사 관내 아동시설<br> 영양지원 재능기부
												</li>
									...
									<tr>
										...
										<td>
											<ol class="director_division_list">
												<li>- 연간 임직원 봉사활동 <br>참여인원 x 시간 x 평균임금 고려시 <br>:
													16백만원 수준
												</li>
											</ol>
										</td>
										<td>
											<ol class="director_division_list">
												<li>- 주요 지역사회 상생활동 임직원 참여</li>
												<li>- 임직원 사회책임 의식 고취</li>
											</ol>
										</td>
									</tr>
								</tbody>
