...
<body>
	...
	<div class="tab_list">
		<li><a href="Group_Ethical_Management.jsp">그룹윤리경영</a></li>
		<li class="on"><a href="Ethics_Report_Center.jsp">윤리신고센터</a></li>
	</div>

	<div>
		<h3 class="esg_title">윤리신고센터</h3>
		<div class="esg_text">
			현대백화점그룹 윤리신고센터는 그룹 임직원이 부정 및 비리에 대해 상담·신고 할 수 있는 곳으로 <br class="pc">윤리경영을
			기업의 최우선가치로 인식하고 또한 이를 모든 임직원의 <br class="pc">올바른 가치 판단 및 행동기준으로
			삼고자 운영하고 있는 제도입니다.
		</div>
		...
		<div style="text-align: center;">
			<a href="http://www.ehyundai.com/newPortal/ir/ETH/ETH000008.do?ir=3"
				class="btn_action comm" target="_blank">제보하기</a>
		</div>
	</div>
