...
<body>
	...
	<div>
		...
		<div class="esg_text">
			현대백화점그룹 윤리신고센터는 그룹 임직원이 부정 및 비리에 대해 상담·신고 할 수 있는 곳으로
			<br class="pc">윤리경영을 기업의 최우선가치로 인식하고 또한 이를 모든 임직원의
			<br class="pc">올바른 가치 판단 및 행동기준으로 삼고자 운영하고 있는 제도입니다.
		</div>

		<ul class="sinmungo_area">
			<li>
				<p class="check_sinmungo"><span>임직원의 부정, 비리, 금품수수</span> <strong>품위손상 등의 부당행위</strong></p>
			</li>
			<li>
				<p class="check_sinmungo"><span>잘못된 관행이나 회사 정책 부문의</span> <strong>개선 및 제안 사항</strong></p>
			</li>
			<li>
				<p class="check_sinmungo"><span>당사와 거래 관련한 제반</span> <strong>불이익 사항</strong></p>
			</li>
		</ul>

		<div style="text-align:center;">
			<a href="http://www.ehyundai.com/newPortal/ir/ETH/ETH000008.do?ir=3" class="btn_action comm"
				target="_blank">제보하기</a>
		</div>
	</div>
</body>
