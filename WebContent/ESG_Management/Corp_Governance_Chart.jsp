	...
	<div>
		<div class="sub_contents">
			...
			<div class="tab_list">
				...
				<li class="on"><a href="Corp_Governance_Chart.jsp">기업지배구조헌장</a></li>
			...
			<h4 class="title_director">
				주요내용 <a target="frm"
					href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/GF_CORPORATEGOVERNANCE.pdf&LOGIC_FILE_NM=GF_CORPORATEGOVERNANCE.pdf"
					class="esg_btn_down">기업지배구조헌장</a>
			</h4>
				...
				<tbody>
					<tr>
						<td style="text-align: left; vertical-align: top;">
							<p>I. 주주</p> &nbsp; - 주주의 권리<br> &nbsp; - 주주의 공평한 대우<br>
							&nbsp; - 주주의 책임<br> <br>
							<p>II. 이사회</p> &nbsp; - 이사회의 기능<br> &nbsp; - 이사회의 구성 및 운영<br>
							&nbsp; - 이사의 선임 및 후보 추천<br> &nbsp; - 이사의 자격 및 독립성<br>
							&nbsp; - 이사의 책임<br> &nbsp; - 이사회 내 위원회<br> &nbsp; -
							사외이사<br> &nbsp; - 평가 및 보상<br>

						</td>
						<td width="175"></td>
						<td style="text-align: left; vertical-align: top;">
							<p>III. 감사기구</p> &nbsp; - 감사위원회<br> &nbsp; - 외부감사인<br>
							&nbsp; <br> &nbsp; <br>
