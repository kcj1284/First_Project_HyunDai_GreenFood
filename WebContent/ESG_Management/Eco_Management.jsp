		...
		<div class="sub_layout esg_area">
			...
			<div class="sub_contents">    
				...
				<section class="esg_section cont2_2_1">
					...
					<div class="esg_text">
						현대그린푸드는 사업활동 전 과정에서 환경을 먼저 생각합니다.
						<br>EHS담당을 중심으로 각 사업부가 참여한 친환경 경영 협의체를 구축하고, 친환경 부문 현안과 이슈사항을 발굴·파악하여
						<br class="pc">부문별 중점 개선과제를 수립·이행하고 있습니다.
					</div>
	
					<div class="esg_text2"><span>E:환경, H:건강, S:안전</span></div>
					<div class="esg_img"><img src="../img/ESG/em_01.jpg" alt=""></div>
				</section>
				...
				<section class="esg_section cont2_2_2">
					...
					<div class="esg_text">
						...
						<br class="pc">전 사업장인 본사 外 3개 센터의 환경목표에 대한 성과를 CEO에 보고하며, 
						<br class="pc">다양한 탄소중립활동을 통한 환경지표 개선 노력을 지속하고 있습니다. 
					</div>
				...
				<section class="esg_section cont2_2_4">
					...
					<div class="esg_img"><img src="../img/ESG/em_02.jpg" alt=""></div>
					<div class="esg_btn">
					...
					<section class="cont2_2_2">
						...
						<div class="esg_img"><img src="../img/ESG/em_03.jpg" alt=""></div>
	
						<h4 class="esg_sub_title">온실가스 배출량 감축</h4>
						<div class="esg_img"><img src="../img/ESG/em_04.jpg" alt=""></div>
	
						<h4 class="esg_sub_title">폐기물 배출량 감축</h4>
						<div class="esg_img"><img src="../img/ESG/em_05.jpg" alt=""></div>
	
						<h4 class="esg_sub_title">용수 사용량 감축</h4>
						<div class="esg_img"><img src="../img/ESG/em_06.jpg" alt=""></div>
	
						<ul class="list">
							<li>
								<h4 class="esg_sub_title">지속가능상품 구매 확대</h4>
								<div class="esg_img"><img src="../img/ESG/em_07.jpg" alt=""></div>
							</li>
							<li>
								<h4 class="esg_sub_title">친환경 제품 매출 확대</h4>
								<div class="esg_img"><img src="../img/ESG/em_08.jpg" alt=""></div>
							</li>
						</ul>
				...
				<section class="esg_section cont2_2_3">
					...
					<div class="esg_text">
						현대그린푸드는 2021년 친환경 경영을 위하여 총 8.7억원을 투자하였습니다.
						<br>이는 당초 계획 대비 20%, 2020년 대비 44%증가한 규모입니다.
					</div>
					...
					<ul class="esg_guide">
						<li>※ LED 설치사업은 ‘14년부터 진행중인 에너지 효율개선 사업으로, <br class="pc">7개년간 173백만원을 투자하여 총 4,128개의 조명을 고효율 장비로 교체하였습니다.</li>
						<li>※ 현대그린푸드는 2022년에 전년 대비 15% 증가한 10억원의 환경경영 투자를 계획하고 있습니다. <br>특히, ‘21년 설치한 태양광 패널을 전국의 센터에 확대하여 신재생에너지 생산 투자를 늘릴 계획입니다. </li>
					</ul>
				</section>
				...
				<section class="esg_section cont2_2_5">
					...
					<div class="esg_text">
						현대그린푸드는 ISO 14001 등을 기반으로 기후변화 요인에 따른 영향을 정기적으로 분석하고 있으며,
						<br class="pc">리스크 최소화 및 사업기회 확대를 통해 실질적인 환경경영이 이루어 질 수 있도록 노력합니다.
						<br>또한, 향후 발생 가능한 이슈에 대해 지속적인 분석을 통해 선제적으로 대응해 나갈 예정입니다.
					</div>
					
					<div class="esg_slider">
						<div><img src="../img/ESG/em_09.jpg" alt=""></div>
						<div><img src="../img/ESG/em_10.jpg" alt=""></div>
					</div>
				</section>
				...
				<section class="esg_section cont2_2_6">
					<h3 class="esg_title">
						신규사업 부문 및 기존 사업에 대한
						<br>환경점검 대응 전략 및 프로세스
					</h3>
					<div class="esg_text">
						당사는 신규사업 추진 시, 위의 기후 변화 요인에 대해 점검하고 있으며, 
						<br class="pc">환경에 대한 이슈 발생 시, 내부적인 점검 프로세스를 통해 적극적으로 대응하고 있습니다.
						<br class="pc">기존 사업과 신규 사업 추진 과정에서 발생할 수 있는 환경 리스크 및 기회 요인 점을 통해
						<br class="pc">환경 경영에 최선을 다하고자 노력합니다.
					</div>
					
					<dl class="esg_list">
						<dt><span>환경 점검 Flow</span></dt>
						<dd><img src="../img/ESG/em_11.jpg" alt=""></dd>
					</dl>
					
					<dl class="esg_list">
						<dt><span>신규 사업 환경 점검 체크리스트</span></dt>
				...
				<section class="esg_section cont2_2_7">
					...
					<div class="esg_btn">
						<a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_1.pdf&LOGIC_FILE_NM=환경경영방침.pdf" class="btn_action comm">환경경영방침</a>
						<a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_2.pdf&LOGIC_FILE_NM=녹색구매방침.pdf" class="btn_action comm">녹색구매방침</a>
						
						<div class="box">
							<a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_3.zip&LOGIC_FILE_NM=환경경영 법규 규제관리.zip" class="btn_action comm">환경경영 법규 규제관리</a>
							<a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_4.pdf&LOGIC_FILE_NM=환경성과평가체계.pdf" class="btn_action comm">환경성과 평가체계</a>
						</div>
						
						<div class="box">
							<a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_5.zip&LOGIC_FILE_NM=환경 리스크 중대성 평가.zip" class="btn_action comm">환경 리스크 중대성 평가</a>
						</div>
					</div>
				</section>
			</div>
