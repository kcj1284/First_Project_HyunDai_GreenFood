...
<body>
    ...
    <section class="esg_section cont2_2_2">
        ...
        <div class="esg_text">
            현대그린푸드는 매년 환경성과 측정을 위한 목표를 수립하고, 개별 환경목표에 대한 성과를 CEO에 보고하며
    ...
    <section class="esg_section cont2_2_4">
        ...
        <section class="cont2_2_2">
            ...
            <h4 class="esg_sub_title">폐기물 사용량 감축</h4>
    ...
    <section class="esg_section cont2_2_3">
        ...
        <ul class="esg_guide">
            ...
            <li>※ 현대그린푸드는 2022년에 전년 대비 15% 증가한 10억원의 환경경영 투자를 계획하고 있습니다. <br>특히, ‘21년 설치한 태양광 패널을 전국의 센터에 확대하여 신재생에너지 생산
                투자를 늘릴 계획입니다. </li>
        </ul>

        <div class="esg_btn">
            <a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_1.pdf&LOGIC_FILE_NM=환경경영방침.pdf"
                class="btn_action comm">환경경영방침</a>
            <a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_2.pdf&LOGIC_FILE_NM=녹색구매방침.pdf"
            ...
            <div class="box">
                <a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_3.pdf&LOGIC_FILE_NM=환경경영법규및규제관리 절차서.pdf"
                    class="btn_action comm">환경경영 법규 및 규제관리 절차서</a>
                <a href="/cm/download.hg?PHYSC_FILE_NM=/static/pdf/CISSM01C_4.pdf&LOGIC_FILE_NM=환경성과평가체계.pdf"
