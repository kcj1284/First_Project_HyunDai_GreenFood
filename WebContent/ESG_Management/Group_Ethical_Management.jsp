...
<body>
	...
	<div>
		...
		<section class="esg_section cont7_1_2 sub_contents">
			...
			<div class="esg_text">
				현대그린푸드는 윤리경영이 기업경쟁력의 원동력임을 깊이 인식하여 ‘정직과 신뢰’를 바탕으로 <br class="pc">직무를 윤리적/합법적으로 수행하고, 공정하고 투명한 거래질서 확립과
				사회적 책임을 충실히 이행함으로써 <br class="pc">신뢰와 존경을 받는 기업이 되고자 다음과 같이 실천합니다.
			</div>
			...
			<ul class="esg_box">
				...
				<li><strong>하나. 우리는 임직원의 보람과 행복을 중시한다.</strong>
					<p>
						우리는 모든 임직원을 회사의 가장 소중한 자산으로 여기고, 개개인의 인간적 존엄성을 존중하며 각자의 자질과 능력에 따라 공평한 기회를 제공하고 <br
							class="pc">정당한 평가를 통해 보상 받을 수 있는 조직문화의 조성을 통해 개인의 꿈과 미래가 보장되는 자랑스러운 일터가 되도록 노력한다.
					</p>
				</li>
				...
				<li><strong>하나. 우리의 약속</strong>
					<p>
						우리는 현대백화점 그룹인으로서의 긍지와 자부심을 갖고 인간미, 도덕성, 예의범절을 생활화하며 명예와 품위를 지키며 <br class="pc">정직하고 공정한 자세로 업무에
						임하여 건전하고 깨끗한 기업문화를 조성하는데 노력한다.
					</p>
				</li>
			</ul>
