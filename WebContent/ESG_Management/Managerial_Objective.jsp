		...
		<div class="sub_layout esg_area">
			...
			<div class="sub_contents">
				<section class="esg_section cont1_1">
					...
					<div class="esg_text">
						현대그린푸드는 미래세대에 ‘희망’을 제시하고 <br class="pc">‘신뢰’받는 기업으로 성장하는 선순환
						체계 구축을 목표로 합니다.
					</div>

					<div class="esg_img">
						<img src="../img/ESG/mo_01.jpg" alt="">
					</div>
				</section>
						...
						<ul>
							<li><i>E</i>
								<div>
									...
									<p>
										지속가능한 생태환경 조성을 위한 <br class="pc">경영전반의 친환경 가치 창출 <br
											class="pc">(친환경 상품/서비스 개발)
									</p>
								</div></li>
							<li><i>S</i>
								<div>
									...
									<p>
										단순 기부가 아닌 <br class="pc">사회문제 해결에 기여하는 <br class="pc">사업
										개발, 추진
									</p>
								</div></li>
							<li><i>G</i>
								<div>
									...
									<p>
										주주 친화 정책 추진 <br class="pc">및 투명한 정보 공개를 통한 <br class="pc">신뢰도
										제고
									</p>
								</div></li>
						</ul>
