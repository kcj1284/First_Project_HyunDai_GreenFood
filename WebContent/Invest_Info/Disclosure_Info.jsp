    ...
    <div class="sub_contents">
        ...
        <div class="director_area">
            ...
            <div class="iframe_area_korea iframe_area_korea2" style="width:750px">
                <!-- <iframe width="100%" height="100%" frameborder="0"  scrolling="auto" marginheight="0" topmargin="0" leftmargin="0" src="/Contents/finance/IIPAI01C_KO.html" title="현대그린푸드  경영공시 정보  - KRX 한국거래소 제공"></iframe> -->
                <iframe width="100%" height="90%" frameborder="0" scrolling="no" marginheight="0" topmargin="0"
                    leftmargin="0"
            ...
            <div class="btn_rule_acrobat">
                ...
                <p class="acrobat_text">
                    <img src="../img/Invest/di_02.jpg" class="icon_gray_ball" alt="" /> PDF 내용을 보시려면
                    Acrobat Reader를 설치해야
                    합니다. <span><img src="../img/Invest/di_03.jpg" alt="Get Adobe Reader" /></span>
                </p>
            </div>
        </div>
    </div>
