...
<div class="container_area" id="contents">
	...
	<div class="sub_layout sub_visual_6">
		...
		<script type="text/javascript">
			...
			var buyer = $('#buyer').val();
			var etc1 = $('#etc1').val();
			var context1 = document.getElementById('qna_chart').getContext('2d');
			var comChart = new Chart(context1, {
				...
				data : { // 차트에 들어갈 데이터
					...
					datasets : [ { //데이터
						...
						data : [ cafeteria, catering, distribution, retail,
								buyer, etc1 //x축 label에 대응되는 데이터 값
						],
						backgroundColor : [
						//색상
		...
		<script type="text/javascript">
			...
			var etc2 = $('#etc2').val();
			var context2 = document.getElementById('company_chart').getContext(
					'2d');
			var qnaChart = new Chart(context2, {
				...
				data : { // 차트에 들어갈 데이터
					...
					datasets : [ { //데이터
						...
						fill : false, // line 형태일 때, 선 안쪽을 채우는지 안채우는지
						data : [ good, bad, proposal, etc2 //x축 label에 대응되는 데이터 값
						],
						backgroundColor : [
						//색상
						'rgba(255, 99, 132, 0.8)', 'rgba(54, 162, 235, 0.8)',
