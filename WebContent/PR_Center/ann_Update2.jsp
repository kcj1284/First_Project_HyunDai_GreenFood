...
<div class="container_area" id="contents">
	...
	<div class="sub_layout sub_visual_6">
		...
		<div class="sub_contents">
			...
			<form method="post" action="/First_Project_HyunDai_GreenFood/HdgfServlet?command=annUpdate&id=${annVO.id}" id="boardFrm" enctype="multipart/form-data">
				...
				<ul>
					...
					<li> file:  <c:if test="${fileVO.id != 0}">&nbsp  &nbsp${fileVO.fileName} </c:if></li> 
					<li> update file:   &nbsp  &nbsp<input type="file" name="file"><br></li>
