...
<div class="sub_layout sub_visual_6">
	...
	<div class="sub_contents">
		...
		<div class="title_description">
			...
			<p class="sub_description">좋은 재료를 더 빠르고 신선하게 제공하는 선진물류시스템을 소개합니다.</p>
		</div>
		<!-- //타이틀 , 디스크립션 -->
		...
		<div class="infra_area">
			...
			<div class="infra_text_area">
				...
				<div class="distribution_map_area">
					...
					<p class="distri_map">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_map.jpg"
							alt="" />
					</p>
					...
					<div class="distri_center distri_center1">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_img1.png"
							alt="" />
					...
					<div class="distri_center distri_center2">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_img2.png"
							alt="" />
					...
					<div class="distri_center distri_center3">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_img3.png"
							alt="" />
					...
					<div class="distri_center distri_center4">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_img4.png"
							alt="" />
					...
					<div class="distri_center distri_center5">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_img5.png"
							alt="" />
					...
					<div class="distri_center distri_center6">
						<img
							src="../img/ESG_infrasystem/distribution_system/distri_img6.png"
							alt="" />
				...
				<ul class="manage_discri_list">
					<li class="manage_discri1">
						<dl>
							<dt>수·배송 능력</dt>
							<dd>
								전국 물류 거점 NETWORK를 통해 Daily 배송 수행<br />약 1,500여 개의 단체급식, 식재고객사,
								유통 Retail 매장에 매일 신선하고 안전한 상품 공급
							</dd>
						</dl>
					</li>
